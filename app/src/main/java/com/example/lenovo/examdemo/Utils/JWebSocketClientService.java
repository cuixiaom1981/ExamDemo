...
import com.example.lenovo.examdemo.Activity.OnlineWebSocketActivity;
...
//                    String list = jsonObject.get("userList").toString();
//                    String [] stringArr= list.split(",");
                        Intent intent = new Intent();
                        intent.setAction("com.xch.servicecallback.content");
                        intent.putExtra("message", res);
//                    intent.putExtra("audio",audio);
                        Log.e("JWebSocketClientService", "收到的message：" + res);
//                    intent.putExtra("onlineList",stringArr);
...
//                        json.put("typeid",id);
                        Log.e("JWebSocketClientService", "收到的id：" + id);
                        MyRunnable t=new MyRunnable(id);
                        t.start();
                           try{ t.join();
                        ...
                        Intent intent = new Intent();
                        intent.setAction("com.xch.servicecallback.content");
                        intent.putExtra("message",t.data);
                        sendBroadcast(intent);
                        checkLockAndShowNotification(message);
                    }
                }catch (JSONException e){
                    System.out.print("JSONException异常");
                }
...
//    -----------------------------------消息通知--------------------------------------------------------
    ...
    private void sendNotification(String content) {
        Intent intent = new Intent();
        intent.setClass(this, OnlineWebSocketActivity.class);
        ...
        try {
            ...
            String result = "";
                ...
                JSONObject jsonObject = new JSONObject(result);
                 audio = jsonObject.get("audio").toString();
            }catch (JSONException e){
...
//            urlCon.setRequestProperty("Content-Type", "application/json;charset=utf-8");
            urlCon.connect();
            int responseCode = urlCon.getResponseCode();
            Log.e("JWebSocketClientService", responseCode+"");
            String line = "";
            String result = "";
            in = new BufferedReader(new InputStreamReader(
                    urlCon.getInputStream()));
            ...
            Log.e("JWebSocketClientService", "语音转文字：" + data1);
